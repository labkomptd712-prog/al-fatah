        ...
        <div class="row g-4">
          ...
          ?>
            <div class="col-12 text-center py-5 text-muted">
                ...
                <p>Belum ada kategori ekstrakurikuler yang tersedia saat ini.</p>
            </div>
          <?php 
          else:
            foreach ($categories as $cat): 
                ...
                if (!empty($cat['cover_image'])) {
                    ...
                    $stmtFirst = $pdo->prepare("SELECT image FROM ekskul_photos WHERE category_id = ? ORDER BY created_at DESC LIMIT 1");
          ...
          ?>
            <div class="col-lg-4 col-md-6" data-aos="zoom-in">
                <a href="ekskul-kategori.php?slug=<?= htmlspecialchars($cat['slug']) ?>" class="gallery-folder-card text-decoration-none">
