    ...
    if ($name === '') {
        ...
        if (empty($error)) {
            try {
                ...
                $error = "Gagal menyimpan fasilitas: " . $e->getMessage();
            }
        }
    }
}
...
<head>
    ...
    <title>Tambah Fasilitas - SDIT Al Fatah</title>
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            <div class="main-header d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="fw-bold text-dark mb-1">Tambah Fasilitas</h4>
                    <p class="text-muted small mb-0">Tambah item sarana prasarana sekolah baru</p>
                </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category_id" id="category_id" class="form-select bg-light border-0 py-2.5 px-3 rounded-3" required>
                            <option value="" disabled <?= empty($category_id) ? 'selected' : '' ?>>-- Pilih Kategori --</option>
                    ...
                    <button type="submit" class="btn btn-brand w-100 py-2.5 rounded-3 fw-bold"><i class="fa-solid fa-plus me-2"></i> Tambah Fasilitas</button>
                </form>
            </div>
        </main>
    </div>
