<?php
// admin/ekskul-categories/list.php
...
try {
    ...
    $stmt = $pdo->query("SELECT c.*, COUNT(p.id) as photo_count FROM ekskul_categories c LEFT JOIN ekskul_photos p ON c.id = p.category_id GROUP BY c.id ORDER BY c.name ASC");
    $categories = $stmt->fetchAll();
} catch (PDOException $e) {
    die("Error fetching ekskul categories: " . $e->getMessage());
}
...
<head>
    ...
    <title>Kategori Ekskul - SDIT Al Fatah</title>
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            <div class="main-header d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="fw-bold text-dark mb-1">Kategori Ekskul (Folder)</h4>
                    <p class="text-muted small mb-0">Kelola pengelompokan folder kegiatan ekstrakurikuler sekolah</p>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pe-4 text-center">
                                                <div class="d-inline-flex gap-2">
                                                    <a href="../ekskul/add.php?category_id=<?= (int) $cat['id'] ?>" class="btn btn-sm btn-outline-success" title="Tambah Foto ke Kategori Ini"><i class="fa-solid fa-plus"></i></a>
