<?php
// admin/ekskul/add.php — halaman tambah foto ekskul (admin & editor)
...
<head>
    ...
    <title>Tambah Foto Ekskul - SDIT Al Fatah</title>
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            <div class="main-header d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="fw-bold text-dark mb-1">Tambah Foto Ekskul</h4>
                    <p class="text-muted small mb-0">Unggah dokumentasi kegiatan ekstrakurikuler sekolah</p>
                </div>
