        ...
        <div class="row g-4">
          ...
          ?>
            <div class="col-12 text-center py-5 text-muted">
                ...
                <p>Belum ada kategori prestasi yang tersedia saat ini.</p>
            </div>
          <?php 
          else:
            foreach ($categories as $cat): 
                ...
                if (!empty($cat['cover_image'])) {
                    ...
                    $stmtFirst = $pdo->prepare("SELECT foto FROM prestasi WHERE category_id = ? ORDER BY created_at DESC LIMIT 1");
          ...
          ?>
            <div class="col-lg-4 col-md-6" data-aos="zoom-in">
                <a href="prestasi-kategori.php?slug=<?= htmlspecialchars($cat['slug']) ?>" class="gallery-folder-card text-decoration-none">
                    <div class="folder-cover-wrapper position-relative overflow-hidden rounded-4 shadow-sm bg-light" style="height: 200px;">
                        ...
                        <div class="photo-count-badge position-absolute top-0 end-0 bg-dark bg-opacity-75 text-white px-3 py-1.5 rounded-bl-4 small" style="border-bottom-left-radius: 12px; font-weight: 600;">
                            <i class="fa-solid fa-trophy me-1"></i> <?= (int)$cat['photo_count'] ?>
                        </div>
                    </div>
